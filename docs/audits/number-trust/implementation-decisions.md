...
- `docs/audits/number-trust/oracle-vocabulary.json` is the generated neutral
  vocabulary artifact for shared category semantics. It is generated by
  `scripts/generate_number_trust_oracle_vocabulary.py` from
  `scripts/number_trust_vocabulary.py` and canonical DAL category sets; do not
  hand-edit the JSON. `tests/test_audit_vocabulary.py` guards the committed
  artifact against generator drift.
