...
def test_txn_identity():
    ...
    tid = compute_txn_id("nfcu", "nfcu_REDACTED", "2026-02-15",
    ...
    t1 = compute_txn_id("nfcu", "nfcu_REDACTED", "2026-02-15",
                        50.0, "Grocery Store")
    t2 = compute_txn_id("nfcu", "nfcu_REDACTED", "2026-02-15",
                        50.0, "Grocery Store")
    _check("Deterministic hash", t1 == t2)
    _check("Hash format", t1.startswith("nfcu:h:"))

    # Different amounts → different IDs
    t3 = compute_txn_id("nfcu", "nfcu_REDACTED", "2026-02-15",
                        51.0, "Grocery Store")
    _check("Different amount → different ID", t1 != t3)

    # Whitespace normalization
    t4 = compute_txn_id("nfcu", "nfcu_REDACTED", "2026-02-15",
                        50.0, "  Grocery  Store  ")
